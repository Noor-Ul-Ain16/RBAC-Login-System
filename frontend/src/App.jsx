  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/add-role" element={<ProtectedRoute allowedRoles={["Admin"]}><AddRole /></ProtectedRoute>} />
        <Route path="/admin/edit-role/:id" element={<ProtectedRoute allowedRoles={["Admin"]}><EditRole /></ProtectedRoute>} />

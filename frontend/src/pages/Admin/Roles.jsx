                    ...
                    <tr key={role.id} className="border-b border-slate-100 hover:bg-slate-50 transition">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center gap-2">
                          ...
                          <button onClick={() => deleteRole(role.id)} className="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded-md text-xs font-semibold transition">Delete</button>
                        </div>
                      </td>
                    </tr>
                  ))
